  ...
  return (
    <div className="reveal" style={{ maxWidth: 820 }}>
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 16 }}>
        <SkillIcon icon={data.icon} title={data.meta?.title || data.skillSlug} size={64} fallback="default" />
        <div>
          <h1 className="page-title" style={{ fontSize: "clamp(30px,4vw,44px)", margin: 0 }}>{data.meta?.title || data.skillSlug}</h1>
