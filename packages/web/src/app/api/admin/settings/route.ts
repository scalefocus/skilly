...
import { getPlatformSettings, setProposalsOpen, setDateFormat, setDuplicateEnforcement, setMaxBundleBytes, setChatPollIntervals, setInstallMaxTtlMonths, setMaxFeaturedSkills, BUNDLE_SIZE_OPTIONS } from "../../../../lib/settings";
...
export async function PATCH(req: Request) {
  ...
  const body = (await req.json().catch(() => ({}))) as { proposalsOpen?: boolean; dateFormat?: string; duplicateEnforcement?: string; maxBundleBytes?: number; chatPollIntervals?: string | number[]; installMaxTtlMonths?: number; maxFeaturedSkills?: number };
